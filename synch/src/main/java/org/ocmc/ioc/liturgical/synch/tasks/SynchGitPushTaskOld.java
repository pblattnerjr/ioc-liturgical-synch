 ...
 *
 */
public class SynchGitPushTaskOld implements Runnable {
	
	private static final Logger logger = LoggerFactory.getLogger(SynchGitPushTaskOld.class);
